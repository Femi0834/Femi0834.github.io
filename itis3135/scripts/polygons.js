...
function getNumber() 
{
    var polygonNumber = parseFloat(prompt("Oshin Operations welcomes you! Type a number 0-10 and we will tell you the name of a polygon with that many sides!"));
...
function getShape(sides) 
{
    ...
    switch (sides) 
    {
        ...
        case 2:
            ...
            break;
        case 3:
            return "A polygon with 3 side is a Triangle";
            break;
        case 4:
            return "A polygon with 4 side is a Quadrilateral";
            break;
        case 5:
